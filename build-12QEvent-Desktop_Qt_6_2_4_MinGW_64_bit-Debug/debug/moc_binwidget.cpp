...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_binWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_binWidget_t qt_meta_stringdata_binWidget = {
    {
QT_MOC_LITERAL(0, 9) // "binWidget"
...
const QMetaObject binWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_binWidget.offsetsAndSize,
    qt_meta_data_binWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_binWidget_t
, QtPrivate::TypeAndForceComplete<binWidget, std::true_type>
